# Generated by Django 3.2.15 on 2023-06-08 13:53
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Settlement_time', models.DateField(blank=True, default=None, null=True, verbose_name='结算时间')),
                ('check_out_time', models.DateField(blank=True, null=True, verbose_name='合同到期日期')),
                ('deposit', models.DecimalField(decimal_places=2, max_digits=20, verbose_name='押金')),
                ('balance', models.DecimalField(decimal_places=2, default=None, max_digits=20, null=True, verbose_name='余额')),
                ('remark', models.CharField(blank=True, max_length=11, null=True, verbose_name='备注')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('floor', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='dorm.floor', verbose_name='楼层')),
            ],
            options={
                'verbose_name': '房屋信息表',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('start_water_code', models.DecimalField(decimal_places=2, max_digits=20, verbose_name='水费表码起')),
                ('end_water_code', models.DecimalField(decimal_places=2, max_digits=20, verbose_name='水费表码止')),
                ('water_sum', models.DecimalField(decimal_places=1, max_digits=20, verbose_name='水表数')),
                ('water_price', models.DecimalField(decimal_places=2, default=4.81, max_digits=20, verbose_name='水费单价')),
                ...
                ('start_electricity_code', models.DecimalField(decimal_places=2, max_digits=20, verbose_name='电表表码起')),
                ('end_electricity_code', models.DecimalField(decimal_places=2, max_digits=20, verbose_name='电表表码止')),
                ('electricity_sum', models.DecimalField(decimal_places=2, max_digits=20, verbose_name='电表数')),
                ...
                ('sum_amount', models.DecimalField(decimal_places=2, default=0, max_digits=20, verbose_name='总金额')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('year_month', models.CharField(blank=True, max_length=100, null=True, verbose_name='备注')),
                ('payable_amount', models.DecimalField(decimal_places=2, max_digits=20, verbose_name='应缴金额')),
                ('deduction_amount', models.DecimalField(decimal_places=2, default=None, max_digits=20, verbose_name='扣款金额')),
                ('deduction_reason', models.CharField(blank=True, default=None, max_length=30, null=True, verbose_name='扣款原因')),
                ('remark', models.CharField(blank=True, default=None, max_length=100, null=True, verbose_name='备注')),
                ('create_user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='dorm.user', verbose_name='创建人')),
                ('people', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='dorm.people', verbose_name='姓名')),
                ('rent_price', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='dorm.rent', verbose_name='租金单价')),
            ],
            options={
                'verbose_name': '租金明细表',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('remark', models.CharField(blank=True, max_length=100, null=True, verbose_name='备注')),
                ('create_user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='dorm.user', verbose_name='创建人')),
                ('people', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='dorm.people', verbose_name='付款人')),
            ],
            options={
                'verbose_name': '付款记录表',
                'verbose_name_plural': '付款记录表',
            },
        ),
        migrations.CreateModel(
            name='DeviceDetail',
